...
<h3 className="py-5 px-5 underline ">Our Mission</h3>
<p className="m-2">At BollyG, our mission is to create a platform to express your movie choices. We believe in quencheing that insatiable hunger for movies from your favorite actors. Whether you are looking for series or movies and we are committed to bringing you the most exciting indian shows.</p>

          
            <h3 className="m-5 underline">Our Vision</h3>
            <p>BollyG began with a vision to of creating a service for a beautiful service for indians to go watc h newly released movies and also classics . Mr Gaiya has always been saddened with the fact that he would have to go do movie stands everyday just to see a movie and hence came the idea . Over the years, we have grown from a pool of movies  to a big movie outlet, thanks to hardwork of the OG "Mr Gaiya"
            </p>
          </div>
